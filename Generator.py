...
class Generator(object):
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim,
        ...
        self.sentence = tf.placeholder(tf.int32, shape=[batch_size, self.rep_sequence_length]) # generated sentence
    ...
    def advtrain_step(self, sess, history, labels, sentence, rewards, baseline):
        ...
        Args:
            ...
            baseline
        """
        feed_dict = {self.enc_inp:history, self.labels: labels, self.sentence: sentence, self.rewards:rewards, self.baseline:baseline}
    ...
    def MC_reward(self, sess, history, sentence, mc_steps, discriminator,
        ...
        for i in range(mc_steps):
            for t in range(1, self.rep_sequence_length):
                ...
                complete_sentence = self.generate(sess, history, gen_input_t)
