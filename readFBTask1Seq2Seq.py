...
def create_con(create_data,MAX_SEQUENCE_LENGTH = 200,MAX_REP_SEQUENCE_LENGTH = 20):
    ...
    if create_data:
        ...
        test_histories = all_hists[-1000:] # (..., cust) last 1000 histories
        test_replies = all_replies [-1000:] # (cust, eos)
        test_in_replies = all_in_replies[-1000:] #(cust)

        train_histories =  all_hists[:-1000] #(..., cust)
        train_replies = all_replies[:-1000] # (cust, eos)
        train_in_replies = all_in_replies[:-1000] #(cust)
